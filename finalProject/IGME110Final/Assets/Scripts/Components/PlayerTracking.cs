/* Component for a entity that wants to know the player location.
 * Effectively just a tag component because when I tried to use
 * the Entity member thePlayerEntity, I always got errors and didn't know
 * how to solve them.
 * 
 * 
 */ 
