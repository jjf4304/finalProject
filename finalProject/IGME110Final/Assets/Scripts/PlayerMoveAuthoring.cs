/* Authoring script for a player movement. 
 * 
 * Assigns a speed value to a player entity.
 * 
 */ 
...
public class PlayerMoveAuthoring : MonoBehaviour, IConvertGameObjectToEntity
{
    ...
    public void Convert(Entity entity, EntityManager dstManager, GameObjectConversionSystem conversionSystem)
    {
        ...
        PlayerMove pMove = new PlayerMove { moveSpeed = MoveSpeed };
        dstManager.AddComponentData(entity, pMove);
